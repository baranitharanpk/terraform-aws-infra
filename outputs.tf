...
output "apache_public_ips" {
  description = "List of Apache public IP addresses"
  value       = aws_instance.apache[*].public_ip
}

output "apache_private_ips" {
  description = "List of Apache private IP addresses"
...
output "nginx_public_ips" {
  description = "List of Nginx public IP addresses"
  value       = aws_instance.nginx[*].public_ip
}

output "nginx_private_ips" {
  description = "List of Nginx private IP addresses"
...
output "all_server_ips" {
  description = "All server public IP addresses"
  value = {
...
output "server_summary" {
  description = "Summary of deployed servers"
  value = {
